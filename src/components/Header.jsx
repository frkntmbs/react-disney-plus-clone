...
import logo from "../img/disney-plus-logo.svg";
import avatar from "../img/avatar.png";
import { MdAdd } from "react-icons/md";

function header() {
  return (
    <div className="header px-9 h-[72px] flex items-center">
      <img className="header-logo" src={logo} alt="Disney Plus Logo" />
      <div className="nav-items">
        <NavLink to="/">
          <svg aria-hidden="true" version="1.1" viewBox="0 0 36 36">
      ...
      <div className="ml-auto flex items-center text-white">
        <span className="m-4 text-sm font-semibold">Furkan</span>
